package com.jhh.dc.loan.entity.lakala.otp;
 ...
 */
public class LakalaOtpResponse extends LakalaCrossPaySuperResponse {
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("LakalaOtpResponse{");

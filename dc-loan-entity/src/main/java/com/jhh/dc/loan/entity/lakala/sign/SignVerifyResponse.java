package com.jhh.dc.loan.entity.lakala.sign;
 ...
 * 拉卡拉跨境支付-签约验证响应参数
 */
public class SignVerifyResponse extends LakalaCrossPaySuperResponse {
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("SignVerifyResponse{");

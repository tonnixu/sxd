package com.jhh.dc.loan.entity.lakala.submit;
 ...
 * 商户下单业务响应参数
 */
public class SubmitOrderResponse extends LakalaCrossPaySuperResponse {
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("SubmitOrderResponse{");

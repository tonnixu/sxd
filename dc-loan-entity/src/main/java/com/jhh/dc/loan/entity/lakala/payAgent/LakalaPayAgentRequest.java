 ...
 */
public class LakalaPayAgentRequest implements Serializable {
    ...
    /**
     * 订单币种，目前只支持人民币 {@link LakalaCurrency}
     */
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("LakalaPayAgentRequest{");

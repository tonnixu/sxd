...
import com.jhh.dc.loan.entity.lakala.LakalaCrossPaySuperResponse;
 ...
 */
public class LakalaGatherResponse extends LakalaCrossPaySuperResponse {
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("LakalaGatherResponse{");

package com.jhh.dc.loan.entity.lakala.gather;


import java.io.Serializable;
import java.util.Map;

import com.jhh.dc.loan.entity.enums.CertType;
import com.jhh.dc.loan.entity.enums.CrossBorderBizType;
 ...
 */
public class LakalaGatherRequest implements Serializable {
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("LakalaGatherRequest{");

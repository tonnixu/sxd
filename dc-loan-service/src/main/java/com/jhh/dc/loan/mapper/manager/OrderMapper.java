...
public interface OrderMapper {
    ...
    //根据合同id查合同编号
    String selectBorrNumById(Integer contractId);
    //根据guid查询订单
    Order selectByGuid(String guid);

    int updateOrder(int orderId, String remark);

    int selectByConStatusTime(String contractId, String state, String type);

    List<Order> selectPayOrders(String contractId, String rlState);

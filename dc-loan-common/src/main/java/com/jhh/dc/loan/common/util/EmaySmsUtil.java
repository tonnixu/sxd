...
public class EmaySmsUtil {
    ...
    private static final String SN_JHHJK = "EUCP-EMY-SMS1-0FNCL";
    private static final String SN_dc = "EUCP-EMY-SMS1-4MFCE";
    ...
    private static final String baseUrl_JHHJK = "http://sdk229ws.eucp.b2m.cn:8080/sdkproxy/";
    ...
    private static final String key_jhhjk ="788689";
    private static final String key_dc ="899550";
    ...
    public static boolean send(String message, String phone, int type) {
        ...
        try {
            ...
            if (type == 1) {
                ...
                param = "cdkey=" + SN_JHHJK + "&password=" + key_jhhjk + "&phone=" + mdn + "&message=" + message + "&addserial="
                        + code + "&seqid=" + seqId;
                url = baseUrl_JHHJK + "sendsms.action";
            }else if (type == 4){
                param = "cdkey=" + SN_dc+ "&password=" + key_dc + "&phone=" + mdn + "&message=" + message + "&addserial="
                        + code + "&seqid=" + seqId;
                url = baseUrl_JHHJK + "sendsms.action";
            } else{
            ...
            System.out.println("短信发送-phone:" + phone + ",结果:" + ret);
    ...
    public static void main(String[] args) {
        ...
        // "【随心贷】尊敬的用户，由于系统原因，随心贷于2017-06-20给您多放款了855元借款。故于2017-07-07从您的银行卡上扣回了855元。给您带来的不便敬请谅解。如有疑问请咨询400-150-8990。谢谢。
        // 请",
        // "13341814726", 1);

//		 boolean flag = EmaySmsUtil.send("【金狐贷】万泽中你好，快来申请随心贷。", "13341814726", 2);
//		boolean flag = EmaySmsUtil.send("", "13341814726", 1);

//		System.out.println(flag);

//		String message1 = "【随心贷】尊敬的用户，由于系统原因，随心贷于2017-06-19给您多放款了855元借款。故于2017-08-10从您的银行卡上扣回了855元。给您带来的不便敬请谅解。如有疑问请咨询400-150-8990。谢谢。";
//		String message2 = "【随心贷】尊敬的用户，随心贷已向您尾号XXXX的银行卡退款XXXX元，请注意查收。如有问题请拨打客服电话400-150-8990。";
...
//
//
//            String message = "【随心贷】尊敬的用户，请重新打开APP进行更新，更新后请重新进行认证，谢谢您的配合。";
//            System.out.println(message);
//            boolean flag = EmaySmsUtil.send(message, phone, 1);
//            System.out.println(flag);
//
//        }
        String phone = "13636569813";
        String message = "【随心贷】尊敬的用户，请重新打开APP进行更新，更新后请重新进行认证，谢谢您的配合。";
        System.out.println(message);

package com.jhh.dc.loan.common.redis;
...
public class JedisUtil {
    ...
    static {
        ...
        try {
            ...
            if (StringUtils.isNotEmpty(constant.getProperty("redis.timeout"))) {
            ...
            if (pwd == null || pwd.isEmpty()) {
                pool = new JedisPool(poolConfig, host, port, timeout, null, db);
            } else {

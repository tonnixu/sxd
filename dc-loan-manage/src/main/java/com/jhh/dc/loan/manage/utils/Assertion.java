...
public abstract class Assertion extends Assert {
	...
	private static Pattern IPV4_NETWORK_ADDRESS_PATTERN = Pattern
	...
	private static Pattern IPV4_NETWORK_ADDRESS_WITH_MASK_PATTERN = Pattern
	...
	private static Pattern MOBILE_NUMBER_PATTERN = Pattern.compile("^((13[0-9])|(15[^4,\\D])|(177)|(18[0,5-9]))\\d{8}$");
	...
	public static void isIpV4NetworkAddress(String value, String message) {
		if (!IPV4_NETWORK_ADDRESS_PATTERN.matcher(value).matches()) {
			throw new IllegalArgumentException(message);
		}
	}
	...
	public static void isIpV4NetworkAddressWithMask(String value, String message) {
		if (!IPV4_NETWORK_ADDRESS_WITH_MASK_PATTERN.matcher(value).matches()) {
			throw new IllegalArgumentException(message);
		}
	}
	...
	public static void isMobileNO(String mobiles,String message){  
		if(!MOBILE_NUMBER_PATTERN.matcher(mobiles).matches()){
			throw new IllegalArgumentException(message);
		}
	}  
}

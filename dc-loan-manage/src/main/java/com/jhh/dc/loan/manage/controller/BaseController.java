...
public class BaseController {
    ...
    public Response handleException(Exception exception) {
        ...
        return new Response().code(5000).msg(exception.getMessage());
    }

    /**
     * 定制异常，
     * 异常返回的code必须按照httpstatus的状态进行返回
     * @param exception
     * @return
     */
    @ExceptionHandler(IllegalArgumentException.class)
    @ResponseBody
    public Response handleCustomerException(IllegalArgumentException exception) {
    	logger.error(exception.getMessage()+"---------", exception);
    	System.out.println("====================================" + exception.getMessage());
    	return new Response().code(4001).msg(exception.getMessage());
    }
